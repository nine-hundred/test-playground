...
RUN echo '{"server":{"port":8080},"database":{"host":"mysql","port":3306,"user":"todouser","password":"password","name":"todoapp"}, "redis": {"host": "redis","port": 6379,"password": "","db": 0}}' > config.json
# 포트 노출
EXPOSE 8080
